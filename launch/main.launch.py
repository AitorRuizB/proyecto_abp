...
def launch_setup(context, *args, **kwargs):
    ...
    nodes.append(Node(
        ...
        name='global_bridge',
        # ¡IMPORTANTE! Forzamos use_sim_time aquí para evitar fallos de TF
        parameters=[{'config_file': global_bridge_path, 'use_sim_time': True}],
        output='screen'
    ))
    ...
    for i in range(1, num_robots + 1):
        ...
        nodes.append(Node(
            ...
            parameters=[{'config_file': local_bridge_path, 'use_sim_time': True}],
            output='screen'
        ))
        ...
        # Gestor de ciclo de vida EXCLUSIVO para arrancar el SLAM
        nodes.append(Node(
